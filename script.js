...
const goldPrices = {
    ...
    1991: { '22_carat_price': 2537.11, '24_carat_price': 3466.00 },
    1992: { '22_carat_price': 3172.48, '24_carat_price': 4334.00 },
    1993: { '22_carat_price': 3030.48, '24_carat_price': 4140.00 },
    1994: { '22_carat_price': 3365.73, '24_carat_price': 4598.00 },
    ...
    1999: { '22_carat_price': 3099.28, '24_carat_price': 4234.00 },
    ...
    2014: { '22_carat_price': 20500.75, '24_carat_price': 28006.50 },
    2015: { '22_carat_price': 19283.44, '24_carat_price': 26343.50 },
    2016: { '22_carat_price': 20952.40, '24_carat_price': 28623.50 },
    2017: { '22_carat_price': 21716.61, '24_carat_price': 29667.50 },
    2018: { '22_carat_price': 23012.61, '24_carat_price': 31438.00 },
    2019: { '22_carat_price': 25781.04, '24_carat_price': 35220.00 },
    2020: { '22_carat_price': 35612.53, '24_carat_price': 48651.00 },
    ...
    fetch(url, {
        ...
        .then(data => {
            if (data && data.price) {
                ...
                document.getElementById('priceDisplay').innerHTML = `<strong>1 Gram of 22 carat Gold: INR ${priceInINRPerGram.toFixed(2)}</strong><br><br><strong>8 Grams of 22 carat Gold: INR ${totalPriceFor8Grams.toFixed(2)}</strong>`;
            } else {
